...
Выходными данными является std::vector<std::array<float, 14>>. Каждый компонент std::array<float, 14> {X0, Y0, x1, y1, w1, x2, y2, w2, x3, y3, w3, x4, y4, w4},
